...
> *No pasar por alto este debate, considerarlo un reto.*
...
> :warning: *Los alumnos deben haber cargado las bases de datos de muestra previamente (en el Prework), se sugiere recordar esto un día antes.*
